export default class Card {
  ...
  constructor(data, cardSelector, handleCardClick) { //data (title, link), cardSelector ('.cards-template')-можно добавлять другой шаблон
  ...
  _getTemplate() { //клонирую элемент из разметки html.
  ...
  _delClickHandler() { // удаляю элемент(карточку).
    this._element.remove();
  }

  _likeCard() { //фиксирую царский лайк.
