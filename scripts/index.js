...
const popupPreviewImage = document.querySelector ('.popup__preview_image');
const buttonClosePreview = document.querySelector('.popup__close-preview');
const previewTitle = document.querySelector('.popup__preview_title');
const initialCards = [
  {
    name: 'Архыз',
